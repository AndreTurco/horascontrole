...
async function compileApk(mode) {
    ...
    const filename = isPrefilled ? 'Controle_de_Horas_Premium_v41.apk' : 'Controle_de_Horas_Limpo_v41.apk';
...
async function main() {
    try {
        ...
        console.log(`   1. Versão Premium: Controle_de_Horas_Premium_v41.apk`);
        console.log(`   2. Versão Limpa: Controle_de_Horas_Limpo_v41.apk`);
        console.log('===================================================');
    } catch (err) {
