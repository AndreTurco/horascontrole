...
function pushTunnelUrlToGit() {
    ...
    const cmd = 'git fetch origin && git rebase origin/main --autostash && git add tunnel_url.json && git commit -m "chore: update active tunnel url [auto]" && git push';
    ...
    try {
        ...
        try {
            ...
            try {
                ...
                console.log();
                console.log(`  ===================================================`);
                console.log(`  TÚNEL REMOTO ATIVO (SERVEO FALLBACK):`);
                console.log(`  > ${currentTunnelUrl}`);
                console.log();
                console.log(`  Escaneie o QR Code abaixo para abrir no celular:`);
                qrcode.generate(currentTunnelUrl, { small: true });
